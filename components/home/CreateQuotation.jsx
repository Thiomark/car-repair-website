...
const CreateQuotation = () => {
    return (
        <div className="hidden absolute left-6 md:flex justify-center z-50">
            <div className="flex items-end justify-center min-h-screen px-4 pt-4 text-center sm:block sm:p-0">
                <span className="hidden sm:inline-block sm:h-screen sm:align-middle" aria-hidden="true">&#8203;</span>

                <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-opacity-90 lg:dark:bg-opacity-100 dark:bg-gray-800 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
